...
func (c *userClient) CreateUser(ctx context.Context, in *InputCreateUser, opts ...grpc.CallOption) (*OutputCreateUser, error) {
	out := new(OutputCreateUser)
	err := c.cc.Invoke(ctx, "/packets.User/CreateUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _User_CreateUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/packets.User/CreateUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).CreateUser(ctx, req.(*InputCreateUser))
	}
